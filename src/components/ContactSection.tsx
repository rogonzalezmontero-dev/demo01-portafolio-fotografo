          ...
          <div className="flex flex-col justify-center">
            <div className="mb-10">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="tel:+598123456789" className="text-muted-foreground hover:text-foreground transition-colors">
                    +598 123 456 789
                  </a>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://instagram.com/r0drig.m" className="social-icon" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
