      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-accent rounded-full flex items-center justify-center">
                ...
                <span className="text-accent-foreground text-xs ml-1">years</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <h2 className="section-heading mb-8">The Story Behind<br />The Lens</h2>
            ...
            <div className="border-t border-border pt-8">
              <h3 className="text-lg font-semibold text-foreground mb-3 uppercase tracking-wider">Bio & Resume</h3>
