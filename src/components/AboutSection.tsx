...
const AboutSection = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-6 md:pt-10">
        <div className="max-w-3xl mx-auto">
          {/* Título con misma tipografía que "Trabajo" */}
          <div className="text-center mb-8 md:mb-12">
            <p className="section-title text-sm md:text-base">Sobre mí</p>
            <h2 className="section-heading text-3xl md:text-4xl lg:text-5xl px-4">
          ...
          {/* Contenedor de texto */}
          <div 
            className="rounded-lg md:rounded-xl lg:rounded-2xl p-5 sm:p-6 md:p-7 lg:p-8 border border-gray-800/30"
            style={{
              backgroundColor: 'rgba(40, 44, 51, 0.88)',
